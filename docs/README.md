...
| [Clerk Setup](./getting-started/CLERK_SETUP.md) | Configure authentication | 15 min |
...
**Backend:** PostgreSQL (Supabase), Clerk Auth, Server Actions
...
2. Set up [Clerk Authentication](./getting-started/CLERK_SETUP.md)
