...
export const ChatEmptyIcon: React.FC<ChatEmptyIconProps> = ({ className = "" }) => {
  return (
    ...
    >
      <rect 
        x="10" y="20" width="80" height="60" rx="8" 
        fill="currentColor" fillOpacity="0.1" 
        stroke="currentColor" strokeWidth="2"
        className="transition-all duration-300 group-hover:fillOpacity-[0.15]"
      />
      ...
      <rect 
        x="30" y="80" width="70" height="45" rx="8" 
        fill="currentColor" fillOpacity="0.05" 
        stroke="currentColor" strokeWidth="2" strokeDasharray="4 4"
        className="transition-all duration-300 group-hover:strokeDasharray-[8,8]"
      />
      ...
      <circle 
        ...
        fill="currentColor" fillOpacity="0.1" 
        stroke="currentColor" strokeWidth="2"
        className="transition-all duration-300 group-hover:r-[27]"
      />
      <path
