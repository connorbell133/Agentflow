...
jest.mock('@/components/features/chat/content/MarkdownContent/MarkdownContent', () => ({
  __esModule: true,
  default: ({ markdown }: { markdown: string }) => <div>{markdown}</div>,
}))

jest.mock('@/components/common/loading/TypingIndicator', () => ({
  __esModule: true,
...
describe('ChatBox Component', () => {
  ...
  describe('Rendering States', () => {
    it('renders empty state when no messages', () => {
      ...
      expect(screen.getByText('Start a conversation by sending your first message below.')).toBeInTheDocument()
    })
