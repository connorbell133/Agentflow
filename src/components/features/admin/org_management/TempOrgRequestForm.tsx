...
import {
  createTempOrgRequest,
  getUserPendingRequest,
  cancelTempOrgRequest,
  getUserApprovedRequest,
  markRequestAsUsed,
} from '@/actions/organization/temp-org-requests';
...
export function TempOrgRequestForm({ user }: TempOrgRequestFormProps) {
  ...
  const { validate, errors, isValidating, clearFieldError } =
    useFormValidation(tempOrgRequestSchema);
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950/30">
              <div className="text-sm text-blue-700 dark:text-blue-200">
                <p className="mb-1 font-medium">Your Organizations:</p>
      ...
      <Card className="shadow-lg">
        <CardContent className="pt-6">
          <div className="space-y-4 text-center">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-foreground">Creating Your Organization</h3>
              <p className="text-muted-foreground">
                Please wait while we set up &quot;
                {approvedRequest?.org_name || approvedRequest?.orgName || 'your organization'}&quot;
                for you...
              </p>
            </div>
          </div>
    ...
    return (
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Great news! Your organization request has been approved. You can now create your
            organization.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/50 rounded-lg p-4">
            <h4 className="mb-2 font-medium text-foreground">What happens when you create?</h4>
  ...
  if (requestState === 'submitted') {
    return (
      <Card className="relative shadow-lg">
        ...
        >
          <svg
            className={`h-4 w-4 ${isCheckingPending ? 'animate-spin' : ''}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="space-y-2">
              ...
              <h3
                ...
                data-testid="org-request-submitted-message"
              >
                Organization Request Sent!
              </h3>
              <p className="text-muted-foreground">
                Your request for &quot;{orgName}&quot; has been submitted for review. We&apos;ll
          ...
          <div className="bg-muted/50 space-y-2 rounded-lg p-4">
            <div>
              ...
              <span className="text-muted-foreground">
                {pendingRequest.org_name || pendingRequest.orgName || 'N/A'}
              </span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="text-muted-foreground">
                {pendingRequest.request_desc || pendingRequest.requestDesc || 'N/A'}
              </span>
            </div>
          </div>
  ...
  if (requestState === 'error') {
    return (
      <Card className="shadow-lg">
        <CardContent className="pt-6">
          <div className="space-y-4 text-center">
            <div className="bg-destructive/10 border-destructive/20 mx-auto flex h-16 w-16 items-center justify-center rounded-full border">
              <svg
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          Tell us about the organization you&apos;d like to create. We&apos;ll review your request
      ...
      <CardContent>
        <form onSubmit={handleSubmitRequest} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">{requestReason.length}/500 characters</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className={`w-full rounded-md border bg-background px-3 py-2 text-sm ${
                errors.additionalInfo ? 'border-destructive' : 'border-input'
              } focus:border-transparent focus:outline-none focus:ring-2 focus:ring-ring`}
              maxLength={1000}
          ...
          <div className="bg-muted/50 rounded-lg p-3">
            <h4 className="mb-2 text-sm font-medium text-foreground">Review Process</h4>
          ...
          <div className="flex space-x-3">
            <Button type="button" variant="outline" onClick={handleGoToChat} className="flex-1">
              Go to Chat
            </Button>
            <Button
              type="submit"
