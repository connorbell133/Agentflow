...
export default function Groups({ org_id, user, org }: GroupsProps) {
      ...
      <>
        ...
        <div className="p-8 text-center text-muted-foreground">
          ...
          <p className="mt-2 text-sm">
            Create your first group to organize users and assign models. Groups help manage
    ...
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {/* Hidden refresh button for E2E tests */}
          <Button
            onClick={() => refresh()}
            size="sm"
