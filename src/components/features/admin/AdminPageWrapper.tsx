...
export function AdminPageWrapper({
    ...
    return (
        <ThemeProvider>
            <SubscriptionContext.Provider value={{ subscription, isLoading: subscriptionLoading, error: subscriptionError }}>
                <DashboardProvider org_id={org.id} initialStats={initialData?.stats}>
                    <AdminDataProvider org_id={org.id} initialData={initialData}>
                        ...
                        <AdminDashboardLayout user={user} org={org} activeTab={activeTab} onTabChange={handleTabChange} subscription={subscription}>
                            <AdminTabContent
                                tab={activeTab}
                                user={user}
                                org={org}
