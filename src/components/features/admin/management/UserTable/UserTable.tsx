...
const UserTable: React.FC<UserTableProps> = ({
  ...
  const renderRow = (user: Profile, index: number, toggleSelect: (id: string) => void) => {
          ...
          <div className="flex items-center gap-1">
            ...
            {!isOrgOwner && (
              <button
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-md p-0 text-destructive hover:bg-muted"
  ...
  return (
    <>
      ...
      <EditUserModal
        ...
        onSaveProfile={async (userId, profile) => {
